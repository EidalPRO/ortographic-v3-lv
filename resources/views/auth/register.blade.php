                ...
                <form class="form" method="POST" action="{{ route('register') }}">
                    ...
                    @error('name')
                        ...
                        {{-- <span class="invalid-feedback" role="alert">
                            <strong>Este nombre ya pertenece a una cuenta</strong>
                        </span> --}}
                    @enderror
                    ...
                    <div class="inputForm">
                        ...
                        <input id="email" type="email" class="input" name="email" value="{{ old('email') }}"
                            required autocomplete="email" placeholder="Ingresa tu correo electronico">

                        @error('email')
                            <script>
                                Swal.fire({
                                    title: "Error",
                                    text: "Este correo electronico ya esta registrado.",
                                    icon: "error"
                                });
                            </script>
                            {{-- <span class="invalid-feedback" role="alert">
                    ...
                    <div class="inputForm">
                        ...
                        <input type="password" id="password" class="input" name="password" required class="input"
                        ...
                        @error('password')
                            <script>
                                Swal.fire({
                                    title: "Error",
                                    text: "Las contraseñas no coinciden y/o minimo debes ocupar 8 caracteres.",
                                    icon: "error"
                                });
                            </script>
                            {{-- <span class="invalid-feedback" role="alert">
                    ...
                    <button class="button-submit">Crear cuenta</button>
                    <p class="p">Ya tienes cuenta? <a href="{{ route('login') }}" class="span">Inicia sesión
                            aquí</a>
                    </p>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>Este email ya pertenece a una cuenta</strong>
                                        </span>
                                    @enderror
                                </div>
                            </div>
